...
author:   Payton Sanford  <pcsanford@aggies.ncat.edu>        
          Malik Jones  <mrjones6@aggies.ncat.edu>  
...
L2sort_asc_101 = sorted(List2)[101]
...
L2sort_dec_101 = sorted(List2,reverse=True)[101]
...
sum_slice_1_solve = List2[0:452:2]
sum_slice_1 = sum(sum_slice_1_solve)
...
sum_slice_2_solve = List2[1:Len_L2:2]
sum_slice_2 = sum(sum_slice_2_solve)
