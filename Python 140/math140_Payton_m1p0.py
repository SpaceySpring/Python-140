...
arr1_even= arr1[0:arr1.shape[0]:2]
...
arr1_list_slice_1 = [10,5,2,0,11]
arr1_list_slice = arr1[arr1_list_slice_1]
...
arr4 = np.arange(200,dtype=float)
...
# a26_sum = np.loadtxt('arr_sum.txt')

# Part k) ----------------------------------------------------
# variable name : arr_obj
# data type : object
# create an array from the list [2,'hello',5.0]
arr_obj_list=[2,'hello',5.0]
arr_obj=np.array(arr_obj_list,dtype = object)
